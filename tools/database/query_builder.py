...
# breaks one peak's traffic apart by all three layers plus scrub center
...
# "All traffic to the target across SCs" — a single number for the whole peak, no breakdown.
...
# "Aggregated per protocol" — how much was TCP vs UDP vs ICMP.
...
# "Aggregated per top destination port" — which services were hit.
